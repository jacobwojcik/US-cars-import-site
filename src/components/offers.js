...
const Offers = () => (
  <section className="sec3">
      <Container>
        <Row>
          <Col>
          <h1 className="blueP"> Nasze aktualne oferty! </h1>
          </Col>
        </Row>
        <Row>
          ...
          <Card style={{ width: '18rem' }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                <p className="blueP">- Silnik 2.5L 400km </p>
                <p className="blueP">- Jeden z lepszych silników na rynku! </p>
                <p className="blueP">- 26 tys. km. przebiegu</p>
                <p className="blueP">- Auto odpala i jeździ</p>
                </Card.Text>
                <a href="https://www.facebook.com/USAUScars/posts/233717334645459" target="_blank"><Button variant="danger">Sprawdź więcej!</Button></a>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={4} className="offerCol">
          <Card style={{ width: '18rem' }}>
              ...
              <Card.Body>
                ...
                <p className="blueP">- Napęd Quattro</p>
                <p className="blueP">- 15 tys. km. przebiegu</p>
                <p className="blueP">- Auto odpala i jeździ</p>
                </Card.Text>
                <a href="https://www.facebook.com/USAUScars/posts/232901921393667" target="_blank"><Button variant="danger">Sprawdź więcej!</Button></a>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={4} className="offerCol">
          <Card style={{ width: '18rem' }}>
              ...
              <Card.Body>
                ...
                <p className="blueP">- Napęd 4matic</p>
                <p className="blueP">- 39 tys. km. przebiegu</p>
                <p className="blueP">- Auto odpala i jeździ</p>
                </Card.Text>
                <a href="https://www.facebook.com/USAUScars/posts/240096900674169" target="_blank"><Button variant="danger">Sprawdź więcej!</Button></a>
              </Card.Body>
            </Card>
          </Col>
          </Row>
