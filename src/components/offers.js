        ...
        <Row>
          ...
          <Card style={{ width: '18rem' }}>
              ...
              <Card.Body>
                ...
                <a href="https://www.facebook.com/USAUScars/posts/233717334645459" target="_blank"><Button variant="success">Sprawdz wiecej</Button></a>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Card style={{ width: '18rem' }}>
              ...
              <Card.Body>
                ...
                <a href="https://www.facebook.com/USAUScars/posts/232901921393667" target="_blank"><Button variant="success">Sprawdz wiecej</Button></a>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={4} className="offerCol">
          <Card style={{ width: '18rem' }}>
              ...
              <Card.Body>
                ...
                <a href="https://www.facebook.com/USAUScars/posts/240096900674169" target="_blank"><Button variant="success">Sprawdz wiecej</Button></a>
              </Card.Body>
            </Card>
          </Col>
          </Row>
